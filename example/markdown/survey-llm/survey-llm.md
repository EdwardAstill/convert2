...
•Version: v18 (major update on March 7, 2026).
...
Yun Nie is with DIRO, Universite´ de Montre´al, Canada.
...
Time
    ...
    1. (b) Query=”Large Language Model”
...
of LLMs is ChatGPT^{2} that adapts the LLMs from the GPT
...
1. 1. Note that a LLM is not necessarily more capable than a small PLM,
...
• KM scaling law^{5}. In 2020, Kaplan et al. [30] (the OpenAI
...
formulas for the scaling law^{6}:
...
where a =_{α+}^{α}_{β} , b =_{α+}^{β}_{β} and G is a scaling coefficient that
can be computed by A, B, α and β. As analyzed in [34],

    1. 5. Since there was not a model trained following this law in the
...
should be denoted by C_{c}^{m}^{in}and C_{m}_{in}, corresponding to the optimal
use of compute. We use the simplified notations for ease of discussions.
1. 4. In existing literature, there is no formal consensus on the minimum
...
is usually difficult to solve complex tasks that involve
    ...
    1. 8. It is difficult to accurately examine the critical size for emergent
...
fundamental research (e.g., grokking^{10}) about the working
...
the ability acquisition of human^{11}. Take the speaking ability
...
1. 10. Grokking refers that “a pattern in the data, improving generaliza-
...
2.2Technical Evolution of GPT-series Models
...
Sutskever^{14} (a co-founder and chief scientist of OpenAI),
the idea of approaching intelligent systems with language

1. 12. https://openai.com/blog/chatgpt-plugins
...
founder-of-openai
    1. 15. To better understand this sentence, we put some explanation
...
ReleaseSizeBaseAdaptationPre-trainLatest DataHardwareTrainingEvaluation
Model
Time(B)ModelITRLHFData ScaleTimestamp(GPUs / TPUs)TimeICLCoT

T5 [82]Oct-201911---1T tokensApr-20191024 TPU v3-✓-
mT5 [83]Oct-202013---1T tokens---✓-
PanGu-α [84]Apr-202113*---1.1TB-2048 Ascend 910-✓-
CPM-2 [85]Jun-2021198---2.6TB-----
T0 [28]Oct-202111T5✓---512 TPU v327 h✓-
CodeGen [86]Mar-202216---577B tokens---✓-
GPT-NeoX-20B [87]Apr-202220---825GB-96 40G A100-✓-
Tk-Instruct [88]Apr-202211T5✓---256 TPU v34 h✓-
UL2 [89]May-202220---1T tokensApr-2019512 TPU v4-✓✓
OPT [90]May-2022175---180B tokens-992 80G A100-✓-
NLLB [91]Jul-202254.5-------✓-
CodeGeeX [92]Sep-202213---850B tokens-1536 Ascend 91060 d✓-
GLM [93]Oct-2022130---400B tokens-768 40G A10060 d✓-
Flan-T5 [69]Oct-202211T5✓-----✓✓
BLOOM [78]Nov-2022176---366B tokens-384 80G A100105 d✓-
mT0 [94]Nov-202213mT5✓-----✓-
Galactica [35]Nov-2022120---106B tokens---✓✓
BLOOMZ [94]Nov-2022176BLOOM✓-----✓-
OPT-IML [95]Dec-2022175OPT✓---128 40G A100-✓✓
LLaMA [57]Feb-202365---1.4T tokens-2048 80G A10021 d✓-
Pythia [96]Apr-202312---300B tokens-256 40G A100-✓-
CodeGen2 [97]May-202316---400B tokens---✓-
StarCoder [98]May-202315.5---1T tokens-512 40G A100-✓✓
LLaMA2 [99]Jul-202370-✓✓2T tokens-2000 80G A100-✓-
Baichuan2 [100]Sep-202313-✓✓2.6T tokens-1024 A800-✓-
QWEN [101]Sep-202314-✓✓3T tokens---✓-
FLM [102]Sep-2023101-✓-311B tokens-192 A80022 d✓-

Publicly
Available

Skywork [103]Oct-202313---3.2T tokens-512 80G A800-✓-

Closed
Source

GPT-3 [55]May-2020175---300B tokens---✓-
GShard [104]Jun-2020600---1T tokens-2048 TPU v34 d--
Codex [105]Jul-202112GPT-3--100B tokensMay-2020--✓-
ERNIE 3.0 [106]Jul-202110---375B tokens-384 V100-✓-
Jurassic-1 [107]Aug-2021178---300B tokens-800 GPU-✓-
HyperCLOVA [108]Sep-202182---300B tokens-1024 A10013.4 d✓-
FLAN [67]Sep-2021137 LaMDA-PT ✓---128 TPU v360 h✓-
Yuan 1.0 [109]Oct-2021245---180B tokens-2128 GPU-✓-
Anthropic [110]Dec-202152---400B tokens---✓-
WebGPT [81]Dec-2021175GPT-3-✓----✓-
Gopher [64]Dec-2021280---300B tokens-4096 TPU v3920 h✓-
ERNIE 3.0 Titan [111] Dec-2021260-------✓-
GLaM [112]Dec-2021 1200---280B tokens-1024 TPU v4574 h✓-
LaMDA [68]Jan-2022137---768B tokens-1024 TPU v357.7 d--
MT-NLG [113]Jan-2022530---270B tokens-4480 80G A100-✓-
AlphaCode [114]Feb-202241---967B tokensJul-2021----
InstructGPT [66]Mar-2022175GPT-3✓✓----✓-
Chinchilla [34]Mar-202270---1.4T tokens---✓-
PaLM [56]Apr-2022540---780B tokens-6144 TPU v4-✓✓
AlexaTM [115]Aug-202220---1.3T tokens-128 A100120 d✓✓
Sparrow [116]Sep-202270--✓--64 TPU v3-✓-
WeLM [117]Sep-202210---300B tokens-128 A100 40G24 d✓-
U-PaLM [118]Oct-2022540PaLM----512 TPU v45 d✓✓
Flan-PaLM [69]Oct-2022540PaLM✓---512 TPU v437 h✓✓
Flan-U-PaLM [69]Oct-2022540U-PaLM✓-----✓✓
GPT-4 [46]Mar-2023--✓✓----✓✓
PanGu-Σ [119]Mar-2023 1085PanGu-α--329B tokens-512 Ascend 910100 d✓-

PaLM2 [120]May-202316-✓-100B tokens---✓✓
...
![image](images/page9_img64.png)

Gopher

![image](images/page9_img37.png)
...
1. 17. GPT-2 essentially used ICL for unsupervised task learning,
...
LLMs and the latest version is Baichuan-2. Both Baichuan
...
PubliclyAvailableModelCheckpoints. To assist re-
...
ness and effectiveness. From LLaMA [57], LLaMA-2 [99],
LLaMA-3 [135] to LLaMA-3.1 [136], continuous updates
...
![image](images/page12_img17.png)

![image](images/page12_img14.png)

![image](images/page12_img12.png)

![image](images/page12_img13.png)

![image](images/page12_img15.png)

![image](images/page12_img16.png)

Math

Finance

MedicineLawBilingualismEducation
...
Alpaca [146] is the first open instruct-following model
...
text-babbage-001,andtext-curie-001.Among
them,thefirstfourinterfacescanbefurtherfine-
tunedonthehostserverofOpenAI.Inparticular,
babbage,curie,anddavincicorrespondtothe
...
five variants^{21}, namely en (806G), en.noclean (6T), real-
newslike (36G), webtextlike (17G), and multilingual (38T).
The en version has been utilized for pre-training T5 [82],
...
andcode-davinci-002.Further,GPT-3.5series
includeonebasemodelcode-davinci-002and
three enhanced versions, namely text-davinci-002,
text-davinci-003,andgpt-3.5-turbo.Asmore
...
applicationscenariosandresponserequirements.The
detailed usage can be found on their project websites^{20}.

*TABLE 2: Statistics of commonly-used data sources.*

CorporaSizeSourceLatest Update Time

BookCorpus [158]5GBBooksDec-2015
Gutenberg [159]-BooksDec-2021
C4 [82]800GB CommonCrawlApr-2019
CC-Stories-R [160]31GBCommonCrawlSep-2019
CC-NEWS [27]78GBCommonCrawlFeb-2019
REALNEWs [161]120GB CommonCrawlApr-2019
OpenWebText [162] 38GBReddit linksMar-2023
Pushift.io [163]2TBReddit linksMar-2023
Wikipedia [164]21GBWikipediaMar-2023
BigQuery [165]-CodesMar-2023
the Pile [166]800GBOtherDec-2020
ROOTS [167]1.6TBOtherJun-2022

3.2Commonly Used Corpora for Pre-training
...
petabyte-scale data volume, which has been widely used
...
this dataset, BigCode furtherprocessed it and released
...
Categories CollectionsTime#Examples

Nat. Inst. [179]Apr-2021193K
FLAN [67]Sep-20214.4M
P3 [180]Oct-202112.1M
Super Nat. Inst. [88] Apr-20225M
MVPCorpus [181]Jun-202241M
xP3 [94]Nov-202281M
OIG[182]Mar-202343M

Task

HH-RLHF [183]Apr-2022160K
HC3 [184]Jan-202387K
ShareGPT [153]Mar-202390K
Dolly [185]Apr-202315K
OpenAssistant [186] Apr-2023161K

Chat

Self-Instruct [147]Dec-202282K
Alpaca [187]Mar-202352K
Guanaco [188]Mar-2023535K
Baize [189]Apr-2023158K
BELLE [190]Apr-20231.5M

Synthetic

*TABLE 4: A list of available collections for alignment.*

DatasetRelease Time #Examples

Summarize from Feedback [129]Sep-2020193K
SHP [191]Oct-2021385K
WebGPT Comparisons [81]Dec-202119K
Stack Exchange Preferences [192]Dec-202110M
HH-RLHF [183]Apr-2022169K
Sandbox Alignment Data [193]May-2023169K
CValues [194]Jul-2023145K
PKU-SafeRLHF [195]Oct-2023330K

3.3Commonly Used Datasets for Fine-tuning
...
3.3.1Instruction Tuning Datasets
...
• vLLM [208] is a fast, memory efficient, and easy-
...
![image](images/page17_img1.png)

![image](images/page17_img2.png)

![image](images/page17_img3.png)

![image](images/page17_img4.png)
...
![image](images/page17_img10.png)

![image](images/page17_img11.png)

⌨ BigQuery (-, 2023), the Pile - GitHub (61G, 2020)

![image](images/page17_img12.png)
...
monCrawl [168]. However, the crawled web data tends to
...
been witnessed by the increasing growth of scientifci publi-
...
Filtering and Selection. To remove low-quality data from
...
<!-- page:19 -->
| Raw CorpusFiltering & SelectionDe-duplication |  |  |  | Ready to
Privacy ReductionTokenization
pre-train! |
| --- | --- | --- | --- | --- |
...
|  | Language Filtering |  | Sentence-level |  |  |
| --- | --- | --- | --- | --- | --- |
|  | Metric Filtering |  | Document-level |  |  |
|  | Statistic Filtering |  | Set-level |  | SentencePiece |
|  | Keyword Filtering |  |  | Remove PII | Byte-level BPE |
|  | Alice is writing a paper about32, 145, 66, 79, 12, 56, ...
...
of data curriculum^{23} applies in continual pre-training.
...
4.1.4Summary of Data Preparation
...
1. 23. We utilize the symbol “→” to represent the data order in data
...
previous token, is used instead of the token representation
as the input.
...
#L denotes the number of layers, #H denotes the number of attention heads, d_{m}_{odel} denotes the size of hidden states, and
MCL denotes the maximum context length during training.*

ModelCategorySizeNormalizationPEActivationBias#L#Hd_{m}_{odel}MCL

GPT3 [55]Causal decoder175BPre LayerNormLearnedGeLU✓9696122882048
PanGU- α [84]Causal decoder207BPre LayerNormLearnedGeLU✓64128163841024
OPT [90]Causal decoder175BPre LayerNormLearnedReLU✓9696122882048
PaLM [56]Causal decoder540BPre LayerNormRoPESwiGLU×11848184322048
BLOOM [78]Causal decoder176BPre LayerNormALiBiGeLU✓70112143362048
MT-NLG [113]Causal decoder530B----105128204802048
Gopher [64]Causal decoder280BPre RMSNormRelative--80128163842048
Chinchilla [34]Causal decoder70BPre RMSNormRelative--80648192-
Galactica [35]Causal decoder120BPre LayerNormLearnedGeLU×9680102402048
LaMDA [68]Causal decoder137B-RelativeGeGLU-641288192-
Jurassic-1 [107]Causal decoder178BPre LayerNormLearnedGeLU✓7696138242048
LLaMA [57]Causal decoder65BPre RMSNormRoPESwiGLU×806481922048
LLaMA 2 [99]Causal decoder70BPre RMSNormRoPESwiGLU×806481924096
Falcon [171]Causal decoder40BPre LayerNormRoPEGeLU×606481922048
GLM-130B [93]Prefix decoder130BPost DeepNormRoPEGeGLU✓7096122882048
T5 [82]Encoder-decoder11BPre RMSNormRelativeReLU×241281024512

Causal DecoderPrefix DecoderEncoder-Decoder
...
ASurveyofLargeLanguage ModelsASurveyofLargeLanguage ModelsASurveyofLargeLanguage Models
...
ferent models. T represents sequence length, H represents
the dimension of the input representation, N represents the
...
ModelDecoding ComplexityTraining Complexity

TransformerO(H(T + H))O(TH(T + H))
SSMO(H(N ^{2} + H))O(TH(log T + N ^{2} + H))
MambaO(H(N ^{2} + H))O(TH(N ^{2} + H))
RWKVO(H^{2})O(TH^{2})
RetNetO(H^{2})O(TH^{2})
HyenaO(MH(T + H))O(TMH(log T + H))

4.2.2Detailed Configuration
...
in a Transformer layer, d denotes the size of hidden states, p_{i} denotes position embedding at position i, A_{ij} denotes the
attention score between a query and a key, r_{i−j} denotes a learnable scalar based on the offset between the query and the
key, and R_{Θ,t} denotes a rotary matrix with rotation degree t · Θ.*

ConfigurationMethodEquation
...
�
RMSNorm [276]_{RM}^{x}_{S(x)} · γ,RMS(x) =
...
Relative [82]Aij = Wqxix^{T}_{j} W_{k}^{T} + ri−j
RoPE [282]Aij = WqxiRΘ,i−jx^{T}_{j} W_{k}^{T} = (WqxiRΘ,i)(W_{k}xjRΘ,j)^{T}

Position embedding

ALiBi [283]Aij = Wqxix^{T}_{j} W_{k}^{T} −m(i −j)
...
elements will rotate based on the rotation angle t · θ_{i}, where
t denotes the position index and θ_{i} is the basis in the
dimension. Following sinusoidal position embeddings [22],
RoPE defines the basis θ_{i} as an exponentiation of the base b
...
coffee0.661strong0.008soup0.005
water0.119black0.008. . .. . .
tea0.057hot0.007happy4.3e-6
rice0.017oat0.006Boh4.3e-6
chai0.012beans0.006. . .. . .
...
tokens x = {x_{1}, . . . , x_{n}}, the LM task aims to autoregres-
sively predict the target tokens x_{i} based on the preceding
tokens x_{<i} in a sequence. A general training objective is to
...
_{i=1}log P(xi|x<i).(6)

4.2.4Decoding Strategy
...
xi = arg _{x}maxP(x|x<i),(8)

where x_{i} is the token with the highest probability at i-
th step of generation conditioned on the context x_{<i}. For
...
inputs x_{\x˜} for DAE task are corrupted text with randomly
...
ImprovementforRandomSampling. Sampling-based
...
where l_{j}^{′} is the logits of each word and t is the temperature
...
1. a. https://www.nvidia.com/en-us/on-
...
monly, its hyper-parameters are set as follows: β_{1} = 0.9,
β_{2} = 0.95 and ϵ = 10^{−8}. Meanwhile, the Adafactor op-
...
are set as: β_{1} = 0.9 and β_{2} = 1.0 −k^{−0.8}, where k denotes
...
<!-- page:29 -->
Batch SizeLearningPrecisionWeightGrad
ModelWarmupDecay MethodOptimizerDropout
(#tokens)RateTypeDecayClip

GPT3 (175B)32K→3.2M6 × 10^{−}^{5}yescosine decay to 10%AdamFP160.11.0-
PanGu-α (200B)-2 × 10^{−}^{5}--Adam-0.1--
OPT (175B)2M1.2 × 10^{−}^{4}yesmanual decayAdamWFP160.1-0.1
PaLM (540B)1M→4M1 × 10^{−}^{2}noinverse square rootAdafactorBF16lr^{2}1.00.1
BLOOM (176B)4M6 × 10^{−}^{5}yescosine decay to 10%AdamBF160.11.00.0
MT-NLG (530B)64 K→3.75M5 × 10^{−}^{5}yescosine decay to 10%AdamBF160.11.0-
Gopher (280B)3M→6M4 × 10^{−}^{5}yescosine decay to 10%AdamBF16-1.0-
Chinchilla (70B)1.5M→3M1 × 10^{−}^{4}yescosine decay to 10%AdamWBF16---
Galactica (120B)2M7 × 10^{−}^{6}yeslinear decay to 10%AdamW-0.11.00.1
LaMDA (137B)256K----BF16---
Jurassic-1 (178B)32 K→3.2M6 × 10^{−}^{5}yes------
LLaMA (65B)4M1.5 × 10^{−}^{4}yescosine decay to 10%AdamW-0.11.0-
LLaMA 2 (70B)4M1.5 × 10^{−}^{4}yescosine decay to 10%AdamW-0.11.0-
Falcon (40B)2M1.85 × 10^{−}^{4}yescosine decay to 10%AdamWBF160.1--
GLM (130B)0.4M→8.25M8 × 10^{−}^{5}yescosine decay to 10%AdamWFP160.11.00.1
T5 (11B)64K1 × 10^{−}^{2}noinverse square rootAdaFactor---0.1
ERNIE 3.0 Titan (260B)-1 × 10^{−}^{4}--AdamFP160.11.0-
PanGu-Σ (1.085T)0.5M2 × 10^{−}^{5}yes-AdamFP16---
...
split into two submatrices, A_{1} and A_{2}, by column, which
can be expressed as Y = [XA_{1}, XA_{2}]. By placing matrices
A_{1} and A_{2} on different GPUs, the matrix multiplication
...
4.3.2Scalable Training Techniques
...
1. 24. Model parallelism is a more broader term that includes tensor
...
5.1.1Formatted Instance Construction
...
|  |  | Demonstrations |  |  |  |
| NLP  Datasets | Q: What is the capital of France?
A: Paris. |  |  |  |  |

![image](images/page31_img4.png)
...
A: Beijing. |  | Here are some ways to lose weight:
1. Eat a healthy diet: Focus on …
2. Increase physical activity: Engage … |  |

  1. (a) Formatting Task Datasets(b) Formatting Daily Chat Data
...
approaches [147] have been proposed for constructing in-
...
are proposed, it is non-trivial to select the high-quality
ones from them to construct the training dataset. Generally,
...
5.1.2Instruction Tuning Strategies
...
Models
#GPU BSTime#GPU BSTime#GPU#Token/s#GPU#Token/s#GPU#Token/s

LLaMA (7B)283.0h1803.5h136.6124.317.5
LLaMA (13B)483.1h1485.1h126.829.914.5
LLaMA (30B)846.1h12414.3h117.743.822.6
LLaMA (65B)16211.2h1460.6h28.882.041.5
...
5.1.3The Effect of Instruction Tuning
...
5.1.4Empirical Analysis for Instruction Tuning
...
1. 25. Due to the limit of computational resources, we cannot conduct
...
DatasetInstructionLexical
Models
MixturesNumbersDiversity

AlpacaFarmMMLUBBH3k

| Item | Value 1 | Value 2 | Value 3 | Value 4 | Value 5 |
| --- | --- | --- | --- | --- | --- |
| LLaMA (7B)①FLAN-T580,00048.4823.7738.5832.79 ②ShareGPT63,18477.3181.3038.1127.71 ③Self-Instruct-52K82,43925.92/^{∗}37.5229.81 ②+ ③145,62348.2271.3641.2628.36 ①+ ②+ ③ | 225,623 | 48.287 | 0.004 | 3.692 | 9.69 |
| ③Self-Instruct-52K82,43925.92/^{∗}37.5229.81 w/ complexity70,00070.4376.9639.7333.25 w/ diversity70,00075.5981.5538.0130.03 w/ diffciulty70,00073.4879.1532.5531.25 w/ scaling | 220,000 | 57.785 | 1.133 | 3.812 | 6.63 |
| LLaMA (13B)①FLAN-T580,00048.4822.1234.1234.05 ②ShareGPT63,18477.3177.1347.4933.82 ③Self-Instruct-52K82,43925.92/^{∗}36.7325.43 ②+ ③145,62348.2272.8541.1629.49 ①+ ②+ ③ | 225,623 | 48.286 | 9.494 | 3.503 | 1.16 |
| ③Self-Instruct-52K82,43925.92/^{∗}36.7325.43 w/ complexity70,00070.4377.9446.8935.75 w/ diversity70,00075.5978.9244.9736.40 w/ diffciulty70,00073.4880.4543.1534.59 w/ scaling | 220,000 | 57.785 | 8.123 | 8.072 | 7.28 |
...
5.2.1Background and Criteria for Alignment
...
literature [66, 366]. In addition, there are other alignment
...
LLMs. In existing work, there are many ways to fulflil these
...
5.2.2Collecting Human Feedback
...
is designed for large-scale model tuning. Specifcially, Prox-
...
• RL fnie-tuning. At this step, aligning (i.e., fine-tuning)
...
RankingTraining with feedback data
...
5.2.3Reinforcement Learning from Human Feedback
...
<!-- page:39 -->
| MHAAdapterFFNAdapter
… |
| --- |

|  |  | Prefix | Layer #N |  | Layer #N |  |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  | … |  | … | Wdown |
| MHAAdapterFFNAdapter |  | Prefix | Layer #1 |  | Layer #1 |  |
...
search decoding algorithm^{26}. It only needs to perform one-
...
Process-SupervisedRLHF.Inexistingliteratureof
...
LLMs refnie the undesired generation contents [374, 375].
...
grained annotation dataset named PRM800k [375] consist-
    ...
    1. 26. https://huggingface.co/docs/transformers/v4.31.0/en/main
...
matical problems is labeled as positive, negative or neutral
...
Fudan^{28}, and Flan-T5-xl from Stanford^{29}.
...
ment dataset, so that LLMs can directly learn aligned behav-
    ...
    1. 27. https://huggingface.co/OpenAssistant
...
quantiles with varying alignment quality, it prepends a spe-
cial reward token to each model response to represent the
...
discussed above^{31}. Actually, RLHF has been demonstrated
...
As a concrete scenario, it would potentially advocate the
    ...
    1. 31. In RLHF, it seems to be also important that reward models
...
1. 30. This part would be somehow subjective, mainly based on the au-
...
5.3Parameter-Efficient Model Adaptation
...
5.3.1Parameter-Efficient Fine-Tuning Methods
...
Prefix Tuning. Prefix tuning [404] prepends a sequence of
...
idea of LoRA is to freeze the original matrix W ∈R^{m}^{×n}

while approximating the parameter update ∆W by low-
rank decomposition matrices, i.e., ∆W = A · B^{⊤}, where
A ∈R^{m}^{×k} and B ∈R^{n×k} are the trainable parameters for
...
related papers on this topic [408, 416].
    ...
    1. 32. Here, prompt tuning denotes a category of related efficient tuning
...
increasingresearchattentionfordevelopingamore
...
GitHub^{34}. It has included several widely used efficient tun-
...
1. 33. https://github.com/tloen/alpaca-lora
...
ApproachRepresentative WorkKey Point
...
Reflexion [443]Feedback acquisition (text-based self-reflection); Plan refniement (dynamic memory)
...
principles as Prin. and list the IDs of the related principles for each prompt. ⃝1: expressing the task goal clearly; ⃝2:
decomposing into easy, detailed sub-tasks; ⃝3: providing few-shot demonstrations; ⃝4: utilizing model-friendly format.*

IngredientCollected PromptsPrin.

T1. Make your prompt as detailed as possible, e.g., “Summarize the article into a short paragraph within 50 words. The major⃝1
storyline and conclusion should be included, and the unimportant details can be omitted.”

Task Description

T2. It is helpful to let the LLM know that it is an expert with a prefixed prompt, e.g., “You are a sophisticated expert in the⃝1
domain of compute science.”

T3. Tell the model more what it should do, but not what it should not do.⃝1
T4. To avoid the LLM to generate too long output, you can just use the prompt: “Question: Short Answer: ”. Besides, you can⃝1
also use the following suffixes, “in a or a few words”, “in one of two sentences”.

I1. For the question required factual knowledge, it is useful to first retrieve relevant documents via the search engine, and⃝4
Input Data
...
C1. For complex tasks, you can clearly describe the required intermediate steps to accomplish it, e.g., “Please answer the⃝2
question step by step as: Step 1 - Decompose the question into several sub-questions, · · · ”

Contextual Information

C2. If you want LLMs to provide the score for a text, it is necessary to provide a detailed description about the⃝1
...
D2. For few-shot chain-of-thought prompting, you can also use the prompt “Let’s think step-by-step”, and the few-shot⃝1⃝3
...
D4. The diversity of the in-context exemplars within the prompt is also useful. If it is not easy to obtain diverse questions,⃝3
...
D8. Order matters for in-context exemplars and prompts components. For very long input data, the position of the question⃝3
(first or last) may also affect the performance.

D9. If you can not obtain the in-context exemplars from existing datasets, an alternative way is to use the zero-shot⃝3
generated ones from the LLM itself.

O1. Let the LLM check its outputs before draw the conclusion, e.g., “Check whether the above solution is correct or not.”⃝2
...
O3. The prompt should be self-contained, and better not include pronouns (e.g., it and they) in the context.⃝1
O4. When using LLMs for comparing two or more examples, the order affects the performance a lot.⃝1
O5. Before the prompt, assigning a role for the LLM is useful to help it better fulfill the following task instruction, e.g., “I⃝1
want you to act as a lawyer”.

O6.OpenAImodelscanperformataskbetterinEnglishthanotherlanguages.Thus,itisusefultofirst⃝4
translate the input into English and then feed it to LLMs.

O7. For multi-choice questions, it is useful to constrain the output space of the LLM. You can use a more detailed explanation⃝1
or just imposing constraints on the logits.

O8. For sorting based tasks (e.g., recommendation), instead of directly outputting the complete text of each item after sorting,⃝1
one can assign indicators (e.g., ABCD) to the unsorted items and instruct the LLMs to directly output the sorted indicators.

As a representative work, Auto-Prompt [413] proposes a
...
test time by utilizing a pre-trained RL agent to sequentially
edit different parts of a manually-written initial prompt. Al-
...
Formally, let D_{k} = {f(x_{1}, y_{1}), . . . , f(x_{k}, y_{k})} represent
a set of demonstrations with k examples, where f(x_{k}, y_{k}) is
the prompt function that transforms the k-th task example
into natural language prompts. Given the task description
I, demonstration D_{k}, and a new input query x_{k+1}, the
prediction of the output yˆ_{k+1} generated from LLMs can be
...
�
LLMI, f(x_{1}, y_{1}), . . . , f(x_{k}, y_{k})
�_{demon}�_{s}�_{trations}�
...
(11)
where the actual answer y_{k+1} is left as a blank to be
...
1. 35. When ICL was introduced in the GPT-3’s paper [55], it was
...
how many candies do you have left? |  | Q: | If a rectangle has a length of 6 cm and a width of 3 cm,
what is the perimeter of the rectangle? |
| The answer is 8.
N x
If a rectangle has a length of 6 cm and a width of 3 cm,
what is the perimeter of the rectangle?
The answer is 18 cm. | A: |  | N x | A: | For a rectangle, add up the length and width and double it.
...
How many marbles does Sam have left? |  |  | Q:    Sam has 12 marbles. He gives 1/4 of them to his sister.
...
ing is involved. According to the discussion in [495], there
...
6.3.2Improved CoT Prompting Strategies
...
6.3.1Basic CoT Prompting Approach
...
<!-- page:53 -->
|  | Sampling-
based CoT | Verification- |  |  |
| --- | --- | --- | --- | --- |
| CoT |  | based CoT | ToT | GoT |
...
ReasonBacktrackAggregateUnevaluated thoughtPositive thoughtNegative thought
...
6.3.3Further Discussion on CoT Prompting
...
| MemoryTool | Environment |
| --- | --- |

InternalExternal

![image](images/page54_img1.png)

![image](images/page54_img2.png)

…

![image](images/page54_img3.png)
...
task planner, plan executor, and environment^{36}. Specifically,
...
1. 36. Despite the similarity with RL, our formulation decouples the
...
calculating the pass rate against the test cases, i.e., pass@k^{37}.
...
reference-based metrics [630–632, 640]. For example, in
    ...
    1. 37. Given k programs generated by the LLM, pass@k is computed as
1 when at least one program passes all test cases, or else 0

<!-- page:57 -->
LevelAbilityTaskDataset

Language ModelingPenn Treebank [540], WikiText-103 [541], the Pile [166], LAMBADA [252]

WMT’14,16,19,20,21,22 [542–547], Flores-101 [548], DiaBLa [549],
Conditional Text GenerationCNN/DailyMail [550], XSum [551], WikiLingua [552]
OpenDialKG [553]
...
Closed-Book QATriviaQA [560], PIQA [561], LC-quad2.0 [562], GrailQA [563], KQApro [564],
CWQ [565], MKQA [566], ScienceQA [567]

Natural Questions [556], OpenBookQA [568], ARC [557], TriviaQA [560],
Open-Book QAWeb Questions [559], MS MARCO [569], QASC [570], SQuAD [571],
WikiMovies [572]
...
CoinFlip [33], ReverseList [33], LastLetter [33], Boolean Assignment [593],
Symbolic ReasoningParity [593], Colored Object [70], Penguins in a Table [70],
Repeat Copy [436], Object Counting [436]

MATH [362], GSM8k [198], SVAMP [594], MultiArith [595], ASDiv [505],
Mathematical ReasoningMathQA [596], AQUA-RAT [597], MAWPS [598], DROP [599],
NaturalProofs [600], PISA [601], miniF2F [602], ProofNet [603]

HonestnessTruthfulQA [558], HaluEval [604]

HelpfulnessHH-RLHF [183]
...
HouseholdVirtualHome [608], BEHAVIOR [609], ALFRED [610],ALFWorld [611]

Interaction with
External Environment

Website EnvironmentWebShop [612], Mind2Web [613]

Advanced

Open WorldMineRL [614], MineDojo [615]

Search EngineHotpotQA [581], TriviaQA [560], Natural Questions [556]

Code ExecutorGSM8k [198], TabMWP [616], Date Understanding [70]

CalculatorGSM8k [198], MATH [362], CARP [617]

Tool Manipulation

Model InterfaceGPT4Tools [618], Gorilla [619]
...
QA, open-book QA^{38}, and knowledge completion.
...
LLMs might be (to some extent) considered as a knowledge
    ...
    1. 38. In this part, open-book QA refers to the QA tasks that require
...
![image](images/page59_img2.png)

![image](images/page59_img4.png)
...
LLMs (Large Language Models).
  ...
  1. (a) Intrinsic hallucination(b) Extrinsic hallucination
...
is diffciult for existing LLMs to accomplish knowledge
...
relyonlogicalrelationsandevidenceaboutfactual
...
reasoning tasks [33, 56, 528]. Further, after reformulating
...
Symbolic Reasoning^{39}.The symbolic reasoning tasks
...
MathematicalReasoning. The mathematical reasoning
...
performance [33].As another practical strategy, continu-
    ...
    1. 39. Following [33], we mainly discuss symbolic reasoning tasks spe-
...
by fnie-tuning LLMs with process-level feedback,
...
7.2.2Interaction with External Environment
...
7.3Benchmarks and Evaluation Approaches
...
7.3.1Comprehensive Evaluation Benchmarks
...
MethodEvaluationModel TypesAbilities/DomainData Source

MMLU [362]Base/Fine-tuned/SpecializedGeneralHuman exam/practice
BIG-bench [70]Base/Fine-tuned/SpecializedGeneralHuman annotation
HELM [522]Base/Fine-tuned/SpecializedGeneralBenchmark collection
Open LLM Leaderboard [709]Base/Fine-tuned/SpecializedGeneralBenchmark collection
AGIEval [710]Base/Fine-tuned/SpecializedGeneralHuman exam/practice
MMCU [711]Base/Fine-tuned/SpecializedGeneralHuman exam/practice
M3KE [712]Base/Fine-tuned/SpecializedGeneralHuman exam/practice
C-Eval [713]Base/Fine-tuned/SpecializedGeneralHuman exam/practice
Xiezhi [714]Base/Fine-tuned/SpecializedGeneralHuman exam/practice
OpenCompass [715]Base/Fine-tuned/SpecializedGeneralBenchmark collection
Chain-of-Thought Hub [716]Base/Fine-tunedGeneralBenchmark collection
KoLA [717]Base/Fine-tunedKnowledge utilizationWeb
ARB [718]Fine-tunedComplex reasoningHuman exam/practice
APIBench [719]Base/Fine-tunedTool manipulationWeb
APIBank [720]Fine-tunedTool manipulationSynthesis
ToolAlpaca [721]Base/Fine-tunedTool manipulationSynthesis
T-Bench [722]Fine-tunedTool manipulationSynthesis
ToolBench [723]Fine-tunedTool manipulationSynthesis
BOLAA [724]Base/Fine-tunedEnvironment interactionBenchmark collection
AgentBench [725]Base/Fine-tunedEnvironment interactionHuman annotation/Synthesis
HaluEval [604]Base/Fine-tunedHuman alignmentHuman annotation/Synthesis
PromptBench [726]Base/Fine-tunedRobustnessBenchmark collection
HumanEval [105]Base/Fine-tuned/SpecializedCode synthesisHuman annotation
MultiMedQA [354]SpecializedHealthcareBenchmark collection
FLUE [727]SpecializedFinanceBenchmark collection
LegalBench [728]SpecializedLegalHuman annotation

Benchmark

Chatbot Arena [729]Base/Fine-tuned/SpecializedHuman AlignmentHuman annotation
Human
SciBench [730]Fine-tunedComplex reasoningHuman exam/practice

AlpacaEval [731]Fine-tunedInstruction followingSynthesis
MT-bench [729]Fine-tunedHuman alignmentHuman annotation
TrustGPT [732]Base/Fine-tunedHuman alignmentBenchmark collection
LMExamQA [733]Base/Fine-tunedKnowledge utilizationSynthesis
ChatEval [734]Base/Fine-tunedKnowledge utilizationBenchmark collection
...
model weights^{40}. Typically, fine-tuned LLMs will be tested
...
1. 41. Experiments with larger models are still in schedule due to the
...
Language GenerationKnowledge Utilization
Models

LBD↑WMT↑XSum↑HumanEval↑TriviaQA↑NaturalQ↑WebQ↑ARC↑WikiFact↑

ChatGPT55.8136.4421.7179.8854.5421.5217.7793.6929.25
Claude64.4731.2318.6351.2240.9213.7714.5766.6234.34
Claude 245.2012.9319.1378.0454.3021.3021.0679.9735.83
Davinci00369.9837.4618.1967.0751.5117.7616.6888.4728.29
Davinci00258.8535.1119.1556.7052.1120.4718.4589.2329.15

LLaMA 2-Chat (7B)56.1212.6216.0011.5938.9312.9611.3272.3523.37
Vicuna (13B)62.4520.4917.8720.7329.0410.7511.5220.6928.76
Vicuna (7B)63.9019.9513.5917.0728.589.176.6416.9626.95
Alpaca (7B)63.3521.528.7413.4117.143.243.0049.7526.05
ChatGLM (6B)33.3416.5813.4813.4213.424.409.2055.3916.01

LLaMA 2 (7B)66.3911.5711.5717.0730.925.152.5124.1628.06
LLaMA (7B)67.6813.848.7715.2434.627.9211.124.8819.78
Falcon (7B)66.894.0510.0010.3728.7410.788.464.0823.91
Pythia (12B)61.195.438.8714.6315.731.994.7211.6620.57
Pythia (7B)56.963.688.239.1510.161.773.7411.0315.75

Knowledge ReasoningSymbolic ReasoningMathematical Reasoning Interaction with Environment
Models

OBQA↑HellaSwag↑SocialIQA↑C-Objects↑Penguins↑GSM8k↑MATH↑ALFW↑WebShop↑

ChatGPT81.2061.4373.2353.2040.2778.4733.7858.9645.12/15.60
Claude81.8054.9573.2359.9547.6570.8120.1876.8747.72/23.00
Claude 271.6050.7558.3466.7674.5082.8732.2477.6134.96/19.20
Davinci00374.4062.6569.7064.6061.0757.1617.6665.6764.08/32.40
Davinci00269.8047.8157.0162.5567.1149.9614.2876.8729.66/15.20

LLaMA 2-Chat (7B)45.6274.0143.8443.4038.939.632.2211.1924.51/5.60
Vicuna (13B)43.6570.5145.9753.5536.9118.503.728.9622.74/5.00
Vicuna (7B)43.8469.2546.2744.2536.2414.033.541.496.90/1.40
Alpaca (7B)47.8269.8147.5539.3540.274.934.164.480.00/0.00
ChatGLM (6B)30.4229.2733.1814.0514.093.411.100.000.00/0.00

LLaMA 2 (7B)44.8174.2541.7243.9535.7510.992.648.960.00/0.00
LLaMA (7B)42.4273.9141.4639.9534.9010.993.122.240.00/0.00
Falcon (7B)39.4674.5842.5329.8024.161.670.947.460.00/0.00
Pythia (12B)37.0265.4541.5332.4026.172.881.965.223.68/0.60
Pythia (7B)34.8861.8241.0129.0527.521.821.467.4610.75/1.80

Human AlignmentTool Manipulation
Models

TfQA↑C-Pairs↓WinoGender↑RTP↓HaluEval↑HotpotQA↑Gorilla-TH↑Gorilla-TF↑Gorilla-HF↑

ChatGPT69.1618.6062.50/72.50/79.173.0766.6423.8067.2044.5319.36
Claude67.9332.7371.67/55.00/52.503.7563.7533.8022.047.747.08
Claude 271.1110.6760.00/60.00/55.833.2050.6336.461.2922.1923.67
Davinci00360.830.9967.50/68.33/79.178.8158.9434.4072.583.806.42
Davinci00253.737.5672.50/70.00/64.1710.6559.6726.002.691.021.00

LLaMA 2-Chat (7B)69.7748.5447.50/46.67/46.674.6143.824.400.000.000.22
Vicuna (13B)62.3045.9550.83/50.83/52.505.0049.0111.200.000.440.89
Vicuna (7B)57.7767.4449.17/49.17/49.174.7043.446.200.000.000.33
Alpaca (7B)46.1465.4553.33/51.67/53.334.7844.1611.600.000.000.11
ChatGLM (6B)63.5350.5347.50/47.50/46.672.8941.824.000.000.000.00

LLaMA 2 (7B)50.0651.3948.83/48.83/50.836.1742.233.800.000.000.11
LLaMA (7B)47.8667.8454.17/52.50/51.675.9414.181.600.000.000.11
Falcon (7B)53.2468.0450.00/50.83/50.006.7137.411.000.000.000.00
Pythia (12B)54.4765.7849.17/48.33/49.176.5927.090.400.000.000.00
Pythia (7B)50.9264.7951.67/49.17/50.0013.0225.840.200.000.000.00
...
TasksDatasetsInstructionsChatGPTSupervised

I want you to act as a translator. Please translate the English20.66
sentence into Czech.
...
| SummarizationXSum | {document} Try your best to summarize the main content of the given42.08 [742]
document. And generate a short summary in 1 sentence for it.\n
Summary: | 23.01 |
| --- | --- | --- |

Choose your answer to the question. {query} {options}85.19
Closed-Book QAARC92.00 [743]
...
Let’s use python to solve math problems. Here are three examples63.20 [744]
...
| --- | --- | --- | --- |
|  | Code SynthesisHumanEvalI want you act as a code completer. Given a code snippet, your
objective is to complete the code and ensure that it can achieve
the described functionality. |  | 79.8848.20 [745] |
| SDG | Text-to-SQLSpider### Complete sqlite SQL query only and with no explanation.\n
#\n### Sqlite SQL tables, with their properties: \n#\n{table}\n#
{foreign_key}\n#\n### {question}\n SELECT |  | 70.1084.10 [746] |

RecommendationMovieLensI’ve watched the following movies in the past in order: \n
...
ReDialRecommend 10 items that are consistent with user preference. The
...
7.4.2Results Analysis and Findings
...
performance by fine-tuning on it. Recent studies [55, 754]
...
shows a content organization of this section^{43}.

8.1LLM for Research Community
...
8.1.1LLM for Classic NLP Tasks
...
improve the generation quality [771]. Despite the above

1. 43. Note that we don’t aim to cover all the related research directions
...
8.1.2LLM for Information Retrieval
...
8.1.3LLM for Recommender Systems
...
8.1.4Multimodal Large Language Model
...
instruction data is key to eliciting and enhancing the abil-
    ...
    1. 44. In existing work, large vision language models (LVLMs) [664] are
...
questions. Similarly, LLaVA [854] utilizes GPT-4 for eval-
...
candidate texts following specific guidelines [352, 649, 729],
...
demonstratestheeffectivenessofLLMsinhandling
...
9.1.1Scaling Position Embeddings
...
dices by a scaling coefficient L/L^{′} (L < L^{′}), where L and
...
in the training phase [351]. Formally, given a fixed rotation

<!-- page:79 -->
angle t · θ_{i}, a smaller basis θ_{i} allows for a greater distance
t, i.e., enabling the modeling of longer texts [254, 295, 940].
According to the formula θ_{i} = b^{−2(i−1)/d} in Equation 4,
...
training length [944]. According to the definition λ_{i} = 2π/θ_{i}
in Equation 5, the dimension with a large wavelength λ_{i}
has a small basis θ_{i} accordingly. Based on this observation,
this approach first defines a basis range [a, c].Given the
basis range, the value of basis is modified according to the
following ways: (1) when θ_{i} ≥c, the value is retained,
(2) when θ_{i} ≤a, the value is set to zero, and (3) when
a < θ_{i}< c, the value is truncated to a fixed small
...
of attention patterns in a Transformer [951], e.g.,the top-
k attention scores can well approximate the original full
...
utilize a k-NN search method to retrieve the k most relevant
tokens for generation [257, 951, 952]. For a decoder model,
it typically employs one certain layer to access these top-
k external tokens, while still adopting the normal context
...
below.
•Parallelcontextwindow.Inspiredbyfusion-in-
...
unit of agents [821]. In this part, we will frist introduce
...
in an LLM-based agent: memory, planning^{45}, and execution.
...
1. 45. Section 6.4 introduces planning as a utilization approach for
...
Robustness and Trustworthiness. The deployment of LLM-
...
9.3Analysis and Optimization for Model Training
...
primarily encompasses two technical issues: fristly, how
...
9.3.1Estimation of Training Memory Consumption
...
utilized in LLM training. For a model containing P param-
eters, both the model parameters and their gradients are
typically stored as 16-bit floating-point numbers, requiring
a total storage of 4P bytes (2P for the parameters and 2P for
...
7B (P ≈6.7 × 10^{9}) requires around 100GB memory to store
...
binary operation Y = W X, calculating the gradient_{∂}^{∂}_{W}^{Y}
...
ponents within the Transformer model. Take LLaMA-7B
...
used to optimize memory usage during backpropagation.
...
need to be multiplied by the number of the layers L when
...
in a memory consumption of 16P bytes per GPU. A direct
...
EquationsActivation consumption

➀Q, K, V = XW ^{Q}^{,K}^{,V}store X with size 2BTH
➁Q, K = RoPE(Q, K)store Q and K with size 4BTH
➂O = Attn (Q, K, V )store Q, K, and Vwith size
6THand results of softmax
with size 2BT ^{2}N
➃X = OW ^{O}store O with size 2BTH
➄X = Add&Norm(X)store X with size 2BTH
➅G, U = X[W ^{G}, W ^{U}]store X with size 2BTH
➆D = Swish(G) · Ustore G and U with size 4BTH^{′}

➇X = DW ^{D}store D with size 2BTH^{′}

➈X = Add&Norm(X)store X with size 2BTH
➉CE(softmax(XW ^{L}))store X with size 2BTH and re-
...
9.3.3Efficiency Optimization Methods
...
9.3.2Memory Optimization Methods
...
results and directly obtain the final result. Ac_{⊺}cording to the
attention computation equation softmax( ^{Q}^{K}

Gradient Checkpointing. Gradient checkpointing [329],
also known as activation recomputation, is a technique
...
GPU’s maximum arithmetic intensity I_{max}, it indicates that
...
ceeds I_{max}, it suggests that the GPU’s maximum floating-
...
1. When using an A100 (80G) GPU with I_{max} = 142.51,
...
9.4Analysis and Optimization for Model Inference
...
9.4.1Analysis of Inference Efficiency
...
maximum arithmetic intensity of the GPU, denoted as I_{max},

9.4.2System-level Optimization
...
EquationsComputationData transferArithmetic intensity

| �
➀Q, K, V = XW ^{Q}^{,K}^{,V}6BTH^{2}O(BTH + H^{2})O_{H1}_{+}^{1}_{B1T} |  | � |
| --- | --- | --- |

➁Q, K = RoPE(Q, K)6BTHO(BTH)O(1)

| �_{1+}_{1}
➂O = Attn(Q, K, V )4BT ^{2}ND + 4BT ^{2}NO(BT ^{2}N + BTND)O | D
1+ 1
D | � |  |
| --- | --- | --- | --- |
| �
➃X = OW ^{O}2BTH^{2}O(BTH + H^{2})O_{H1}_{+}^{1}_{B1T} |  | � |  |
| �
➄X = Add&Norm(X)5BTHO(BTH + H)O_{1+}^{1}_{B1T} |  | � |  |
| �
➅G, U = X[W ^{G}, W ^{U}]4BTHH^{′}O(BTH + BTH^{′} + HH^{′})O | 1
1+ 1
H |  | � |
...
➆D = Swish(G) · U2BTH^{′}O(BTH^{′})O(1)

| �
➇X = DW ^{D}2BTHH^{′}O(BTH + BTH^{′} + HH^{′})O | 1
1+ 1
H |  | � |
| --- | --- | --- | --- |
...
| �
➀q, k, v = XW ^{Q}^{K}^{V}6BH^{2}O(BH + H^{2})O_{H1}_{+}^{1}_{1} |  | � |  |
| --- | --- | --- | --- |
| ➁q, k = RoPE(q, k)6BHO(BH)O(1)
➂K, V = Cache(k, v)-O(BTND) or O(BND)- | B |  |  |
| �_{1+}_{1}
➃o = Attn(q, K, V )4BTND + 4BTNO(BTN + BTND + BND)O | D
1+ 1 | � |  |
| �
➄X = oW ^{O}2BH^{2}O(BH + H^{2})O_{H1}_{+}^{1}_{1} | + 1
D | � |  |
| �
➅X = Add&Norm(X)5BHO(BH + H)O_{1+}^{1}_{1} | � |  |  |
| �
➆g, u = X[W ^{G}, W ^{U}]4BHH^{′}O(BH + BH^{′} + HH^{′})O | B |  | � |
|  | + 1
H′ |  |  |
| ➇d = Swish(g) · u2BH^{′}O(BH^{′})O(1) |  | B |  |
| �
➈X = dW ^{D}2BHH^{′}O(BH + BH^{′} + HH^{′})O | 1
1+ 1
H |  | � |
|  | + 1
H′ | B |  |
...
9.4.3Algorithm-level Optimization
...
<!-- page:86 -->
and can be pre-processed before model deployment. By
...
weightsareeasiertobequantizedthanactivations,
...
where each entry s_{j} = max(x_{j})^{α}/ max(w_{j})^{(1−α)} is deter-
...
loss: arg min_{W�} ∥WX −W�X ∥^{2}_{2}. To efficiently optimize
...
will briefly review several representative PTQ methods^{48} for
LLMs.
...
function: x_{q} = R(x/S) −Z, which transforms a floating
number x into a quantized value x_{q}. In this function, S
and Z denote the scaling factor (involving two parameters
α and β that determine the clipping range) and zero-point
...
1. 48. Since we mainly focus on discussing quantization methods in the
...
<!-- page:87 -->
and difficulty migration [1007], can be applied to alleviate
...
decomposition [1001], fine-grained quantization [766, 1001]
...
9.5.2Other Model Compression Methods
...
porates additional loss functions (i.e., distillation loss) for
...
AlpacaFarmMMLUBBHMem._{(G}_{iB)}AlpacaFarmMMLUBBHMem._{(G}_{iB)}AlpacaFarmMMLUBBHMem._{(G}_{iB)}

LLaMA (7B)FLAN-v26.6547.3435.0512.586.1547.0235.176.657.8346.2334.773.94
Alpaca-52K32.5540.8733.6612.5833.6039.9834.386.6529.5739.2432.803.94
ShareGPT72.0541.3032.9012.5872.8639.3432.716.6570.3140.0832.113.94

LLaMA (13B)FLAN-v28.1451.6741.4624.407.6451.0241.2512.537.5250.4840.687.34
Alpaca-52K33.6047.6336.1024.4031.4347.0435.9812.5330.8746.2036.167.34
ShareGPT75.5947.5838.0024.4073.7947.7138.3112.5371.9945.7736.977.34
...
optimizers [1023]. It focuses on the quantization of both
...
• GPTQ-for-LLaMA^{50} is developed specially for quantiz-
...
• AutoGPTQ^{51} is a quantization package developed
...
• llama.cpp^{52} makes it feasible to run quantized LLaMA
...
• Torch-Pruning ^{53} is a toolkit developed for general-
...
and BNScalePruner).
• LLM-Pruner^{54} is designed specifically for the pruning
...
9.6Retrieval-Augmented Generation
...
puts [1030], or it can perform a confidence assessment to

determine whether the current task requires retrieval or the
...
iate better utilize of context documents. Additionally, LLMs
...
original document as queries and then trains the model to

reconstruct the remaining content of the original document
...
9.7.1Definition of Hallucination
...
plays a key role in shaping the behaviors of LLMs. We next
...
weaker models with this data. However, these synthesized

data may contain hallucinated content, which might lead
...
introduced (e.g., beam search, top-p sampling). However,
...
to the uncertainty of their outputs [1051]. Based on such
...
the evidence and the generated text. LLM-Augmenter [661]

further expands the knowledge source to local databases,
...
long chain-of-thought (CoT) reasoning^{55}, which is the main-
...
significantly more time to think through difficult problems
    ...
    1. 55. The phrase “long CoT” may not be conceptually precise since the
...
processes for complex reasoning.
...
and “avoid”.
Togainamorecomprehensiveunderstandingof
this complex reasoning mode, some research has fur-

ther analyzed the reasoning patterns exhibited in the o1
...
9.8.2Construction of Long CoT Data
...
ness of o1-like LLMs endowed with powerful reasoning
...
tion involves not only reconsidering past decisions but also

assessing whether each agent’s contribution is grounded
...
Long CoT Instruction Tuning. As discussed in Section 9.8.1,
...
enhanced by other supervised training strategies [1067],

<!-- page:95 -->
problems with specific answers are selected. The ground-
...
domain serves as the major source of training data, where
...
scaling law demonstrated by OpenAI^{56}. This law suggests
...
10CONCLUSION AND FUTURE DIRECTIONS
...
topics,includinglongcontextmodeling,LLM-
...
[18]S. Kombrink, T. Mikolov, M. Karafai´t, and L. Burget,
...
in 27th Annual Meeting of the Association for Computa-
...
in EMNLP-CoNLL 2007, Proceedings of the 2007 Joint
...
[17]T. Mikolov, M. Karafai´t, L. Burget, J. Cernocky´, and
...
tilli, T. Fe´vry, J. A. Fries, R. Teehan, T. L. Scao, S. Bi-
...
P.Liang,J.Dean,andW.Fedus,“Emergent
...
D.deLasCasas,L.A.Hendricks,J.Welbl,
...
K. Zhang, C. Ji, Q. Yan, L. He, H. Peng, J. Li, J. Wu,
    ...
    1. Z. Liu, P. Xie, C. Xiong, J. Pei, P. S. Yu, and L. Sun,
...
<!-- page:102 -->
abs/2212.09597, 2022.
[53]J. Zhou, P. Ke, X. Qiu, M. Huang, and J. Zhang,
...
M. Lachaux, T. Lacroix, B. Rozie`re, N. Goyal, E. Ham-
...
A. Mueller, N. Kim, S. Bowman, and E. Perez, “The
...
A. S. Iyer, A. Andreassen, A. Santilli, A. Stuhlmu¨ller,
...
guagemodeltrainingonGPUclustersusing
...
D. Hesslow, R. Castagne´, A. S. Luccioni, F. Yvon,
M. Galle´, J. Tow, A. M. Rush, S. Biderman, A. Web-
...
V. Goswami, F. Guzma´n, P. Koehn, A. Mourachko,
...
[95]S. Iyer, X. V. Lin, R. Pasunuru, T. Mihaylov, D. Simig,
    ...
    1. P. Yu, K. Shuster, T. Wang, Q. Liu, P. S. Koura,
X. Li, B. O’Horo, G. Pereyra, J. Wang, C. Dewan,
A. Celikyilmaz, L. Zettlemoyer, and V. Stoyanov,
...
B. Li, C. Cheng, W. Lu¨, R. Hu et al., “Skywork:
...
B. Zoph, L. Fedus, M. P. Bosma, Z. Zhou, T. Wang,
    ...
    1. Y. E. Wang, K. Webster, M. Pellat, K. Robinson, K. S.
Meier-Hellstern, T. Duke, L. Dixon, K. Zhang, Q. V.
Le, Y. Wu, Z. Chen, and C. Cui, “Glam: Efficient
...
har, F. Triefenbach, A. Verma, G. Tu¨r, and P. Natara-
jan,“Alexatm20b:Few-shotlearningusinga
...
Elias, R. Green, S. Mokra´, N. Fernando, B. Wu,
...
[121]A. Radford, R. Jo´zefowicz, and I. Sutskever, “Learn-
...
[134]——, “Lessons learned on language model safety
and misuse,” OpenAI blog, 2022.
...
S. Pathak, L. Sifre, M. Rivie`re, M. S. Kale, J. Love,
P. Tafti, L. Hussenot, A. Chowdhery, A. Roberts,
A.Barua,A.Botev,A.Castro-Ros,A.Slone,
A. He´liou, A. Tacchetti, A. Bulanova, A. Paterson,
...
abs/2403.08295, 2024.
[140]M. Rivie`re, S. Pathak, P. G. Sessa, C. Hardin, S. Bhu-
patiraju, L. Hussenot, T. Mesnard, B. Shahriari,
A. Rame´, J. Ferret, P. Liu, P. Tafti, A. Friesen, M. Cas-
...
K. Greene, L. L. Sjo¨sund, L. Usui, L. Sifre, L. Heuer-
...
[142]Q.Team,“Qwen2.5:Apartyoffoundation
models,”September2024.[Online].Available:
...
alpaca:Aninstruction-followingllamamodel,”
...
modelengine,”https://github.com/LianjiaTech/
BELLE, 2023.
[152]W.-L. Chiang, Z. Li, Z. Lin, Y. Sheng, Z. Wu,
H. Zhang, L. Zheng, S. Zhuang, Y. Zhuang, J. E.
Gonzalez,I.Stoica,andE.P.Xing,“Vicuna:
Anopen-sourcechatbotimpressinggpt-4with
...
[159]“Projectgutenberg.”[Online].Available:https:
//www.gutenberg.org/
...
imer, F. d’Alche´-Buc, E. B. Fox, and R. Garnett, Eds.,
2019, pp. 9051–9062.
[162]A.Gokaslan,V.C.E.Pavlick,andS.Tellex,
...
[165]“Bigquerydataset.”[Online].Available:https:
...
<!-- page:108 -->
1. S. Presser, and C. Leahy, “The pile: An 800gb dataset
...
[168]“Commoncrawl.”[Online].Available:https://
commoncrawl.org/
[169]G. Wenzek, M.-A. Lachaux, A. Conneau, V. Chaud-
hary, F. Guzma´n, A. Joulin, and E´. Grave, “Ccnet:
...
N. V. Nayak, A. Sharma, T. Kim, M. S. Bari, T. Fe´vry,
...
[186]A. Ko¨pf, Y. Kilcher, D. von Ru¨tte, S. Anagnostidis, Z.-
...
io/, 2023.
[189]C.Xu,D.Guo,N.Duan,andJ.McAuley,
...
ofPython+NumPyprograms,”2018.[Online].
...
forcloningchatgptwithacomplete
rlhfpipeline,”2023.[Online].Available:
...
L. Antiga, A. Desmaison, A. Ko¨pf, E. Z. Yang,
...
andT.Thrush.(2023)Huggingfaceh4
stackexchangepreferencedataset.[On-
...
Annual Meeting of the Association for Computational
Linguistics,ACL2020,Online,July5-10,2020,
...
Wallach, H. Larochelle, A. Beygelzimer, F. d’Alche´-
...
abs/2206.14858, 2022.
[219]T. Saier, J. Krause, and M. Fa¨rber, “unarxive 2022:
...
[230]G. Penedo, H. Kydl´ıcˇek, A. Lozhkov, M. Mitchell,
...
[232]M. Marion, A.U¨stu¨n, L. Pozzobon, A. Wang,
...
and R. Ferna´ndez, “The LAMBADA dataset: Word
...
[256]C.Xu,C.Rosset,L.DelCorro,S.Mahajan,
...
8424–8445.
[237]N. Carlini, D. Ippolito, M. Jagielski, K. Lee, F. Trame`r,
...
[246]M. Davis and M. Du¨rst, “Unicode normalization
forms,” 2001.
...
2022, 17-23 July 2022, Baltimore, Maryland, USA, 2022,
pp. 4057–4086.
[266]A. Gu, K. Goel, and C. Re´, “Efficiently modeling
...
S. Baccus, Y. Bengio, S. Ermon, and C. Re´, “Hyena
...
[271]Y. Sun, L. Dong, S. Huang, S. Ma, Y. Xia, J. Xue,
    ...
    1. J. Wang, and F. Wei, “Retentive network: A successor
to transformer for large language models,” arXiv
...
353–355.
[280]P.Ramachandran,B.Zoph,andQ.V.Le,
...
internalcovariateshift,”inProceedingsofthe
32nd International Conference on Machine Learning,
ICML2015,Lille,France,6-11July2015,ser.
...
C. Alberti, S. Ontan˜o´n, P. Pham, A. Ravula, Q. Wang,
...
F. Lebro´n, and S. Sanghai, “Gqa: Training gener-
...
F.R.BachandD.M.Blei,Eds.,vol.37.
JMLR.org, 2015, pp. 448–456. [Online]. Available:
http://proceedings.mlr.press/v37/ioffe15.html
[285]S. Narang, H. W. Chung, Y. Tay, L. Fedus, T. Fe´vry,
...
L. Ma`rquez, Eds.Association for Computational

<!-- page:114 -->
1. K. Macherey, J. Klingner, A. Shah, M. Johnson, X. Liu,
L. Kaiser, S. Gouws, Y. Kato, T. Kudo, H. Kazawa,
K. Stevens, G. Kurian, N. Patil, W. Wang, C. Young,
J. Smith, J. Riesa, A. Rudnick, O. Vinyals, G. Cor-
rado, M. Hughes, and J. Dean, “Google’s neural
...
modularpytorchlibraryforhighperformance
andlargescaletraining,”https://github.com/
...
[341]YuLan-Chat-Team,“Yulan-chat:Anopen-source
...
[347]O.SenerandS.Savarese,“Activelearning
forconvolutionalneuralnetworks:Acore-set
...
andD.Chen,“LESS:selectinginfluential
datafortargetedinstructiontuning,”CoRR,
...
thatlearnfromhumanfeedback,”CoRR,vol.
...
[363]M. Suzgun, N. Scales, N. Scha¨rli, S. Gehrmann,
...
<!-- page:116 -->
1. V. Mikulik, and G. Irving, “Alignment of language
...
N.McAleese,“Teachinglanguagemodelsto
...
J.Zhang,K.Shum,andT.Zhang,“RAFT:
...
modelsviafine-grainedreinforcementlearning
withminimumeditingconstraint,”CoRR,vol.
...
modelswithhumanfeedbackwithouttears,”
...
[400]T.Zhang,F.Liu,J.Wong,P.Abbeel,and
    ...
    1. J. E. Gonzalez, “The wisdom of hindsight makes
languagemodelsbetterinstructionfollowers,”
...
[402]S.Levine,“Shouldiimitateorreinforce,”
2022.[Online].Available:https://www.youtube.
com/watch?v=sVPm7zOrBxM
[403]J.Schulman,“Reinforcementlearningfrom
...
andS.Paul,“Peft:State-of-the-artparameter-
...
[428]A.Creswell,M.Shanahan,andI.Higgins,
...
[432]D. Zhou, N. Scha¨rli, L. Hou, J. Wei, N. Scales,
...
K.Richardson,P.Clark,andA.Sabhar-
wal,“Decomposedprompting:Amodular
approachforsolvingcomplextasks,”CoRR,
vol.abs/2210.02406,2022.[Online].Available:
https://doi.org/10.48550/arXiv.2210.02406
[434]L. Wang, W. Xu, Y. Lan, Z. Hu, Y. Lan, R. K.
Lee,andE.Lim,“Plan-and-solveprompting:
...
taxonomyofLLMpromptsforbenchmarking
complex tasks,” CoRR, vol. abs/2305.11430, 2023.
[Online]. Available: https://doi.org/10.48550/arXiv.
2305.11430
[448]OpenAI,“Gptbestpractices,”OpenAI,2023.
...
[450]——,“Awesomechatgptprompts,”Github,
...
[452]L.Beurer-Kellner,M.Fischer,andM.Vechev,
...
J.Geiping,andT.Goldstein,“Hardprompts
made easy: Gradient-based discrete optimization
forprompttuninganddiscovery,”CoRR,vol.
...
“Morl-prompt:Anempiricalanalysisofmulti-
...
abs/2402.17564, 2024.
[473]H.YangandK.Li,“Instoptima:Evolutionary
...
languagemodelswithevolutionaryalgorithms
...
J.Zhang,N.Jojic,E.P.Xing,andZ.Hu,
...
[500]E. Akyu¨rek, D. Schuurmans, J. Andreas, T. Ma, and
...
J.X.Wang,andE.Schulz,“Meta-in-context
...
grove, C. D. Manning, C. Re´, D. Acosta-Navas, D. A.
Hudson, E. Zelikman, E. Durmus, F. Ladhak, F. Rong,
H. Ren, H. Yao, J. Wang, K. Santhanam, L. J. Orr,
L. Zheng, M. Yu¨ksekgo¨nu¨l, M. Suzgun, N. Kim,
...
terjee, M. R. Costa-jussa`, C. Federmann, M. Fishel,
...
M. Morishita, M. Nagata, T. Nakazawa, M. Nova´k,
...
D. Ju, S. Krishnan, M. Ranzato, F. Guzma´n, and
...
[550]R. Nallapati, B. Zhou, C. N. dos Santos, C¸ . Gu¨lc¸ehre,
...
V. Logacheva, C. Monz, M. Negri, A. Ne´ve´ol, M. L.
...
[544]L. Barrault, O. Bojar, M. R. Costa-jussa`, C. Feder-
mann, M. Fishel, Y. Graham, B. Haddow, M. Huck,
P. Koehn, S. Malmasi, C. Monz, M. Mu¨ller, S. Pal,
...
C. Monz, M. Negri, A. Ne´ve´ol, M. L. Neves, M. Post,
...
F. Bougares, R. Chatterjee, M. R. Costa-jussa`, C. Fed-
...
jussa`, C. Espan˜a-Bonet, A. Fan, C. Federmann,
...
Papers, A. Korhonen, D. R. Traum, and L. Ma`rquez,
Eds.Association for Computational Linguistics,
2019, pp. 4791–4800.
...
[578]F. Petroni, T. Rockta¨schel, S. Riedel, P. S. H. Lewis,
...
L. Ma`rquez, C. Callison-Burch, J. Su, D. Pighin, and
...
10 746.
[611]M. Shridhar, X. Yuan, M. Coˆte´, Y. Bisk, A. Trischler,
...
R.Socher,andD.R.Radev,“Summeval:Re-
...
2023.
[648]Y. Liu, S. Feng, D. Wang, Y. Zhang, and H. Schu¨tze,
“Evaluatewhatyoucan’tevaluate:Unassess-
ablegeneratedresponsesquality,”CoRR,vol.
abs/2305.14658, 2023.
...
V. Karpukhin, N. Goyal, H. Ku¨ttler, M. Lewis, W. Yih,
T. Rockta¨schel, S. Riedel, and D. Kiela, “Retrieval-
...
K. Chaudhuri, S. Jegelka, L. Song, C. Szepesva´ri,
...
Yu,Y.Yang,J.Callan,andG.Neubig,“Ac-
...
T. Odrzygo´zdz, P. Milos, Y. Wu, and M. Jamnik,
...
abs/2211.09066, 2022.
[695]A.Parisi,Y.Zhao,andN.Fiedel,“TALM:
...
sivetoolsviatoolembeddings,”CoRR,vol.
abs/2305.11554, 2023.
...
R.Murthy,Y.Feng,Z.Chen,J.C.Niebles,
    ...
    1. D. Arpit, R. Xu, P. Mui, H. Wang, C. Xiong, and
...
large pre-trained language model for fniancial do-
main,” CoRR, vol. abs/2211.00083, 2022.
[728]N. Guha, D. E. Ho, J. Nyarko, and C. Re´, “Legal-
...
M. Noetel, and A. Stuhlmu¨ller, “RAFT: A real-world
...
“Relationextraction:Asurvey,”arXivpreprint
...
gata, T. Nakazawa, M. Negri, A. Ne´ve´ol, M. Neves,
...
andZ.Tu,“Document-levelmachinetransla-
...
onchatgptandfine-tunedBERT,”CoRR,vol.
abs/2302.10198, 2023.
...
P. Cudre´-Mauroux, Eds.ACM, 2020, pp. 1893–1902.
...
rankingfromimplicitfeedback,”CoRR,vol.
abs/1205.2618, 2012.
...
andF.Yuan,“Exploringtheupperlimitsof

<!-- page:135 -->
text-based collaborative flitering using large lan-
...
[864]E. Jime´nez-Ruiz, O. Hassanzadeh, V. Efthymiou,
...
H.Wu,andH.Wang,“ERNIE3.0:Large-
scaleknowledgeenhancedpre-trainingfor
...
token-levelhallucinationdetection,”CoRR,vol.
abs/2310.09044, 2023.
...
A. T. Stu¨ber, J. Topalis, T. Weber, P. Wesp, B. O.
...
[905]E. Kasneci, K. Seßler, S. Ku¨chemann, M. Bannert,
D. Dementieva, F. Fischer, U. Gasser, G. Groh,
S. Gu¨nnemann, E. Hu¨llermeier et al., “Chatgpt for
...
[961]S.RussellandP.Norvig,ArtificialIntelligence:
...
p. 59.
[980]T. Dao, D. Y. Fu, S. Ermon, A. Rudra, and C. Re´,
“Flashattention: Fast and memory-efficient exact at-
tention with io-awareness,” in NeurIPS, 2022.
...
<!-- page:141 -->
1. B. Chen, P. Liang, C. Re´, I. Stoica, and C. Zhang,
...
viaMIIanddeepspeed-inference,”CoRR,vol.
abs/2401.08671, 2024.
...
[990]B. Spector and C. Re´, “Accelerating LLM infer-
...
ICLR (Poster).OpenReview.net, 2018.
[994]C.Wang,J.Zhang,andH.Chen,“Semi-
autoregressiveneuralmachinetranslation,”in
...
of-depths:Dynamicallyallocatingcomputein
...
languagemodels:Asurvey,”2024.[Online].
...
T.Hoefler,andD.Alistarh,“Spqr:Asparse-
quantizedrepresentationfornear-losslessLLM
...
ApplicationsofArtificialIntelligence,IAAI2024,
Fourteenth Symposium on Educational Advances in
ArtificialIntelligence,EAAI2014,February20-
...
distillationoflargelanguagemodels,”CoRR,
...
“Distillingstep-by-step!outperforminglarger
languagemodelswithlesstrainingdataand
...
[1028] D. Rau, S. Wang, H. De´jean, and S. Clinchant, “Con-
...
augmentedinstructionlearning,”arXivpreprint
...
[1062] K. Li, O. Patel, F. B. Vie´gas, H. Pfister, and M. Watten-
