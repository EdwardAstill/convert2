...
1. 1. Introduction and Motivating Work
...
<!-- page:3 -->
Learning Transferable Visual Models From Natural Language Supervision3

Zero-Shot ImageNet Accuracy

4X efficiency3X efficiency

Bag of Words Contrastive (CLIP)
Bag of Words Prediction
Transformer Language Model

2M33M 67M134M268M400M
# of images processed
...
^{1}The base query list is all words occurring at least 100 times in
the English version of Wikipedia. This is augmented with bi-grams

<!-- page:4 -->
Learning Transferable Visual Models From Natural Language Supervision4
...
eral modifciations to the original version using the ResNet-
...
<!-- page:5 -->
Learning Transferable Visual Models From Natural Language Supervision5
...
<!-- page:6 -->
Learning Transferable Visual Models From Natural Language Supervision6
...
<!-- page:7 -->
Learning Transferable Visual Models From Natural Language Supervision7
...
^{2}Alec learned much more about flower species and German
...
<!-- page:8 -->
Learning Transferable Visual Models From Natural Language Supervision8
...
<!-- page:9 -->
Learning Transferable Visual Models From Natural Language Supervision9
...
diffciult tasks that a learner has no prior experience with,
...
we estimate the effective data effciiency based on a log-
...
<!-- page:10 -->
Learning Transferable Visual Models From Natural Language Supervision10
...
<!-- page:11 -->
Learning Transferable Visual Models From Natural Language Supervision11
...
effciiency. We also find that CLIP vision transformers are
...
vision transformers are more compute effciient than con-
vnets when trained on suffciiently large datasets. Our best
...
<!-- page:12 -->
Learning Transferable Visual Models From Natural Language Supervision12
...
form all evaluated systems in terms of compute effciiency.
...
bel for all traffci and street signs. This could encourage
a supervised representation to collapse intra-class details
and hurt accuracy on a fine-grained downstream task. As
mentioned, CLIP still underperforms the EffciientNet on
several datasets. Unsurprisingly, the dataset that the Eff-i
...
lack of scale-based data augmentation in CLIP. The Eff-i
cientNet also does slightly better on PatchCamelyon and
CLEVRCounts, datasets where overall performance is still

<!-- page:13 -->
Learning Transferable Visual Models From Natural Language Supervision13
...
^{3}We refer readers to Hendrycks et al. (2020a) for additional
experiments and discussion on this claim.

<!-- page:14 -->
Learning Transferable Visual Models From Natural Language Supervision14
...
^{4}We caution that a zero-shot model can still exploit spurious
...
<!-- page:15 -->
Learning Transferable Visual Models From Natural Language Supervision15
...
![image](images/page15_img34.png)

![image](images/page15_img35.png)

![image](images/page15_img32.png)

![image](images/page15_img31.png)

![image](images/page15_img33.png)

![image](images/page15_img36.png)
...
![image](images/page15_img20.png)

![image](images/page15_img21.png)

![image](images/page15_img5.png)

![image](images/page15_img6.png)

![image](images/page15_img19.png)

![image](images/page15_img22.png)

|  |  |  |  | ImageNet
ResNet101 | Zero-Shot |  |
| --- | --- | --- | --- | --- | --- | --- |
|  |  |  | Dataset ExamplesΔ Score |  | CLIP |  |
|  |  |  |  | 76.276.2 |  | 0% |
|  |  |  |  | 64.370.1 |  | +5.8% |
|  |  |  |  | 37.788.9 |  | +51.2% |
|  |  |  |  | 32.672.3 |  | +39.7% |
|  |  |  |  | 25.260.2 |  | +35.0% |
| 65707580859095100
Average on class subsampled ImageNet (top-1, %) |  | ImageNet-A |  | 2.777.1 |  | +74.4% |
...
to use the fxied 1000-way classifier of an ImageNet model
...
<!-- page:16 -->
Learning Transferable Visual Models From Natural Language Supervision16
...
1. 4. Comparison to Human Performance
...
We had fvie different humans look at each of 3669 images
...
suffciiently motivated in the zero-shot task. High human
accuracy of 94% on the STL-10 dataset (Coates et al., 2011)

^{5}There is not a perfect correspondence between the human
...
<!-- page:17 -->
Learning Transferable Visual Models From Natural Language Supervision17
...
Majority VoteAccuracy
Accuracy
on Full Dataseton Guesses

Zero-shot human53.757.069.763.9
Zero-shot CLIP93.593.593.593.5
One-shot human75.780.378.581.2
Two-shot human75.785.079.286.1
...
use the following procedure:
    ...
    1. 1) For each evaluation dataset, we run a duplicate detector
...
<!-- page:18 -->
Learning Transferable Visual Models From Natural Language Supervision18
...
1. 2) We then compute the zero-shot accuracy of CLIP
...
2. 3) The amount of overlap is often small so we also run a
...
changes in the class distribution or diffciulty of the dupli-
...
<!-- page:19 -->
Learning Transferable Visual Models From Natural Language Supervision19
...
0.02.55.07.510.012.515.017.520.022.5
...
effciiency of CLIP with the flexibility of a caption model.
...
<!-- page:20 -->
Learning Transferable Visual Models From Natural Language Supervision20
...
plex tasks and visual concepts can be diffciult to specify
...
<!-- page:21 -->
Learning Transferable Visual Models From Natural Language Supervision21

ModelRaceGenderAge

FairFace Model93.794.259.7
Linear Probe CLIP93.496.563.8
Zero-Shot CLIP58.395.957.1
Linear Probe Instagram90.893.254.2
...
FairFace Model75.494.460.7
Linear Probe CLIP92.897.763.1
Zero-Shot CLIP91.397.254.3
Linear Probe Instagram87.293.954.1
...
ModelGender Black White Indian Latino EasternAsianAsian Average

Male96.996.498.796.598.996.296.997.2
Linear Probe CLIPFemale97.996.797.999.297.298.597.397.8
97.496.598.397.898.497.397.197.5

Male96.396.497.797.298.395.596.896.9
Zero-Shot CLIPFemale97.195.398.397.897.597.296.497.0
96.795.998.097.598.096.396.6

Male92.594.896.293.196.092.793.494.1
Linear Probe Instagram Female90.191.495.094.895.094.194.393.4
91.393.295.694.095.693.493.9
...
outlined in Buolamwini & Gebru (2018) and Ka¨rkka¨inen
...
the face image dataset FairFace (Ka¨rkka¨inen & Joo, 2019)^{6}

^{6}FairFace is a face image dataset designed to balance age, gen-
...
classification tests we ran^{7}. ZS CLIP’s performance varies
...
^{7}One challenge with this comparison is that the FairFace model
uses binary classes for race (“White” and “Non-White”), instead
of breaking down races into finer-grained sub-groups.

<!-- page:22 -->
Learning Transferable Visual Models From Natural Language Supervision22

MiddleSoutheastEast
CategoryBlackWhiteIndianLatinoEasternAsianAsian

Crime-related Categories16.424.924.410.819.74.41.3
Non-human Categories14.45.57.63.72.01.90.0
...
Category Label Set0-23-910-1920-2930-3940-4950-5960-69over 70

Default Label Set30.335.029.516.313.918.519.116.210.4
Default Label Set + ‘child’ category2.34.314.715.013.418.218.615.59.4
...
<!-- page:23 -->
Learning Transferable Visual Models From Natural Language Supervision23
...
<!-- page:24 -->
Learning Transferable Visual Models From Natural Language Supervision24
...
identified with χ^{2} tests with the threshold at 0.5%. Labels are sorted by absolute frequencies. Bars denote the percentage of images for a
...
wild’ identity detection using the CelebA dataset^{8}. We did
...
^{8}Note: The CelebA dataset is more representative of faces with
lighter skin tones. Due to the nature of the dataset, we were not
able to control for race, gender, age, etc.

<!-- page:25 -->
Learning Transferable Visual Models From Natural Language Supervision25

Model100 Classes1k Classes2k Classes
...
reduced performance^{9}. This process of characterization can
...
^{9}A model could be unfit for use due to inadequate performance
or due to the inappropriateness of AI use in the application area
itself.

<!-- page:26 -->
Learning Transferable Visual Models From Natural Language Supervision26
...
Webly-Supervised Visual Concept Learning (Divvala et al.,
    ...
    1. 2014) has a notably similar ambition and goal as CLIP.

Finally, CLIP is related to a recent burst of activity on learn-
ing joint models of vision and language (Lu et al., 2019; Tan

<!-- page:27 -->
Learning Transferable Visual Models From Natural Language Supervision27
...
<!-- page:28 -->
Learning Transferable Visual Models From Natural Language Supervision28
...
<!-- page:29 -->
Learning Transferable Visual Models From Natural Language Supervision29
...
Gomez, L., Patel, Y., Rusin˜ol, M., Karatzas, D., and Jawahar,
...
Grill, J.-B., Strub, F., Altche´, F., Tallec, C., Richemond,
...
S., and Re´, C. Training classifiers with natural language
...
Kerkwijk, M. H., Brett, M., Haldane, A., Ferna´ndez del

<!-- page:30 -->
Learning Transferable Visual Models From Natural Language Supervision30

R´ıo, J., Wiebe, M., Peterson, P., Ge´rard-Marchant, P.,
...
<!-- page:31 -->
Learning Transferable Visual Models From Natural Language Supervision31
...
Ka¨rkka¨inen, K. and Joo, J. Fairface: Face attribute dataset
...
Lee, D.-H. Pseudo-label: The simple and effciient semi-
...
<!-- page:32 -->
Learning Transferable Visual Models From Natural Language Supervision32
...
<!-- page:33 -->
Learning Transferable Visual Models From Natural Language Supervision33
...
<!-- page:34 -->
Learning Transferable Visual Models From Natural Language Supervision34
...
German Traffci Sign Recognition Benchmark: A multi-
...
Tan, M. and Le, Q. V. Effciientnet: Rethinking model
...
<!-- page:35 -->
Learning Transferable Visual Models From Natural Language Supervision35
...
Touvron, H., Vedaldi, A., Douze, M., and Je´gou, H. Fix-
...
yArcas,B.A.,Mitchell,M.,andTodorov,
A.Physiognomy’snewclothes.2017.
URLhttps://medium.com/@blaisea/
...
<!-- page:36 -->
Learning Transferable Visual Models From Natural Language Supervision36
...
<!-- page:37 -->
Learning Transferable Visual Models From Natural Language Supervision37

1. A. Linear-probe evaluation
...
CLIP-RNFive ResNet-based contrastive CLIP models
...
CLIP-ViTWe include four CLIP models that use the Vi-
...
EfficietNetWe use the nine models (B0-B8) from the
...
Instagram-pretrained ResNeXtWe use the four models
...
|  | SimCLRv2The SimCLRv2 (Chen et al., 2020c) project
released pre-trained and fine-tuned models in various set-
tings. We use the seven pretrain-only checkpoints with
selective kernels. |
| --- | --- |
| LM RN50This is a multimodal model that uses an au-
toregressive loss instead of a contrastive loss, while using | BYOLWe use the recently released model weights of
BYOL (Grill et al., 2020), specifically their 50x1 and 200x2 |

<!-- page:38 -->
Learning Transferable Visual Models From Natural Language Supervision38

![image](images/page38_img1.png)

![image](images/page38_img2.png)
...
VirTexWe use the pretrained model of VirTex (Desai &
...
ResNetWe add the original ResNet checkpoints released
...
<!-- page:39 -->
Learning Transferable Visual Models From Natural Language Supervision39

DatasetClassesTrain sizeTest sizeEvaluation metric

Food-10110275,75025,250accuracy
CIFAR-101050,00010,000accuracy
CIFAR-10010050,00010,000accuracy
Birdsnap50042,2832,149accuracy
SUN39739719,85019,850accuracy
Stanford Cars1968,1448,041accuracy
FGVC Aircraft1006,6673,333mean per class
Pascal VOC 2007 Classification205,0114,95211-point mAP
Describable Textures473,7601,880accuracy
Oxford-IIIT Pets373,6803,669mean per class
Caltech-1011023,0606,085mean-per-class
Oxford Flowers 1021022,0406,149mean per class

MNIST1060,00010,000accuracy
Facial Emotion Recognition 2013832,1403,574accuracy
STL-101010008000accuracy
EuroSAT1010,0005,000accuracy
RESISC45453,15025,200accuracy
GTSRB4326,64012,630accuracy
KITTI46,770711accuracy
Country21121143,20021,100accuracy
PatchCamelyon2294,91232,768accuracy
UCF1011019,5371,794accuracy
Kinetics700700494,80131,669mean(top1, top5)
CLEVR Counts82,000500accuracy
Hateful Memes28,500500ROC AUC
Rendered SST227,7921,821accuracy
ImageNet10001,281,16750,000accuracy
...
<!-- page:40 -->
Learning Transferable Visual Models From Natural Language Supervision40
...
LM RN5081.3 82.8 61.7 44.2 69.6 74.9 44.9 85.5 71.5 82.8 85.5 91.1 96.6 60.1 95.3 93.4 84.0 73.8 70.2 19.0 82.9 76.4 51.9 51.2 65.2 76.8 65.2

5086.4 88.7 70.3 56.4 73.3 78.3 49.1 87.1 76.4 88.2 89.6 96.1 98.3 64.2 96.6 95.2 87.5 82.4 70.2 25.3 82.7 81.6 57.2 53.6 65.7 72.6 73.3
10188.9 91.1 73.5 58.6 75.1 84.0 50.7 88.0 76.3 91.0 92.0 96.4 98.4 65.2 97.8 95.9 89.3 82.4 73.6 26.6 82.8 84.0 60.3 50.3 68.2 73.3 75.7
50x491.3 90.5 73.0 65.7 77.0 85.9 57.3 88.4 79.5 91.9 92.5 97.8 98.5 68.1 97.8 96.4 89.7 85.5 59.4 30.3 83.0 85.7 62.6 52.5 68.0 76.6 78.2
50x1693.3 92.2 74.9 72.8 79.2 88.7 62.7 89.0 79.1 93.5 93.7 98.3 98.9 68.7 98.6 97.0 91.4 89.0 69.2 34.8 83.5 88.0 66.3 53.8 71.1 80.0 81.5
50x6494.8 94.1 78.6 77.2 81.1 90.5 67.7 88.9 82.0 94.5 95.4 98.9 98.9 71.3 99.1 97.1 92.8 90.2 69.2 40.7 83.7 89.5 69.1 55.0 75.0 81.2 83.6

CLIP-RN

B/3288.8 95.1 80.5 58.5 76.6 81.8 52.0 87.7 76.5 90.0 93.0 96.9 99.0 69.2 98.3 97.0 90.5 85.3 66.2 27.8 83.9 85.5 61.7 52.1 66.7 70.8 76.1
B/1692.8 96.2 83.1 67.8 78.4 86.7 59.5 89.2 79.2 93.1 94.7 98.1 99.0 69.5 99.0 97.1 92.7 86.6 67.8 33.3 83.5 88.4 66.1 57.1 70.3 75.5 80.2
L/1495.2 98.0 87.5 77.0 81.8 90.9 69.4 89.6 82.1 95.1 96.5 99.2 99.2 72.2 99.7 98.2 94.1 92.5 64.7 42.9 85.8 91.5 72.0 57.8 76.2 80.8 83.9
15273.7 93.5 78.0 55.1 61.6 52.8 48.4 84.5 71.9 93.0 92.1 89.6 98.2 57.0 97.6 97.0 83.1 70.1 70.2 12.3 82.9 75.3 49.2 42.4 53.2 53.9 77.1
...
<!-- page:41 -->
Learning Transferable Visual Models From Natural Language Supervision41
...
<!-- page:42 -->
Learning Transferable Visual Models From Natural Language Supervision42
...
![image](images/page42_img1.png)

![image](images/page42_img2.png)

![image](images/page42_img3.png)

![image](images/page42_img4.png)
...
<!-- page:43 -->
Learning Transferable Visual Models From Natural Language Supervision43
...
RN5081.1 75.6 41.6 32.6 59.6 55.8 19.3 82.1 41.7 85.4 82.1 65.9 66.6 42.2 94.3 41.1 54.2 35.2 42.2 16.1 57.6 63.6 43.5 20.3 59.7 56.9 59.6
RN10183.9 81.0 49.0 37.2 59.9 62.3 19.5 82.4 43.9 86.2 85.1 65.7 59.3 45.6 96.7 33.1 58.5 38.3 33.3 16.9 55.2 62.2 46.7 28.1 61.1 64.2 62.2
RN50x486.8 79.2 48.9 41.6 62.7 67.9 24.6 83.0 49.3 88.1 86.0 68.0 75.2 51.1 96.4 35.0 59.2 35.7 26.0 20.2 57.5 65.5 49.0 17.0 58.3 66.6 65.8
RN50x1690.5 82.2 54.2 45.9 65.0 72.3 30.3 82.9 52.8 89.7 87.6 71.9 80.0 56.0 97.8 40.3 64.4 39.6 33.9 24.0 62.5 68.7 53.4 17.6 58.9 67.6 70.5
RN50x6491.8 86.8 61.3 48.9 66.9 76.0 35.6 83.8 53.4 93.4 90.6 77.3 90.8 61.0 98.3 59.4 69.7 47.9 33.2 29.6 65.0 74.1 56.8 27.5 62.1 70.7 73.6

CLIP-ResNet

B/3284.4 91.3 65.1 37.8 63.2 59.4 21.2 83.1 44.5 87.0 87.9 66.7 51.9 47.3 97.2 49.4 60.3 32.2 39.4 17.8 58.4 64.5 47.8 24.8 57.6 59.6 63.2
B/1689.2 91.6 68.7 39.1 65.2 65.6 27.1 83.9 46.0 88.9 89.3 70.4 56.0 52.7 98.2 54.1 65.5 43.3 44.0 23.3 48.1 69.8 52.4 23.4 61.7 59.8 68.6
L/1492.9 96.2 77.9 48.3 67.7 77.3 36.1 84.1 55.3 93.5 92.6 78.7 87.2 57.5 99.3 59.9 71.6 50.3 23.1 32.7 58.8 76.2 60.3 24.3 63.3 64.0 75.3
L/14-336px93.8 95.7 77.5 49.5 68.4 78.8 37.2 84.3 55.7 93.5 92.8 78.3 88.3 57.7 99.4 59.6 71.7 52.3 21.9 34.9 63.0 76.9 61.3 24.8 63.3 67.9 76.2
...
<!-- page:44 -->
Learning Transferable Visual Models From Natural Language Supervision44

1. B. Zero-Shot Prediction
...
Linear ClassifierZero Shot
DatasetYFCCWIT∆YFCCWIT∆
...
Dataset Average65.566.6−1.129.630.0−0.4
Dataset “Wins”1015−51918+1

*Table 12. CLIP performs similarly when trained on only
YFCC100M.ComparingaResNet-50trainedononly
...
the canonical ImageNet dataset.*
    ...
    1. D. Dataset Ablation on YFCC100M
...
<!-- page:45 -->
Learning Transferable Visual Models From Natural Language Supervision45
...
1. E. Selected Task and Dataset Results
...
<!-- page:46 -->
Learning Transferable Visual Models From Natural Language Supervision46

Text RetrievalImage Retrieval
Flickr30kMSCOCOFlickr30kMSCOCO
R@1R@5R@10R@1R@5R@10R@1R@5R@10R@1R@5R@10

Unicoder-VL^{a}86.296.399.062.387.192.871.590.994.946.776.085.3
Uniter^{b}87.398.099.265.788.693.875.694.196.852.979.988.0
VILLA^{c}87.997.598.8---76.394.296.8---
Oscar^{d}---73.592.296.0---57.582.889.8
ERNIE-ViL^{e}88.798.099.2---76.793.696.4---

Finetune

Visual N-Grams^{f}15.435.745.18.723.133.38.821.229.95.014.521.9
ImageBERT^{g}---44.071.280.4---32.359.070.2
Unicoder-VL^{a}64.386.892.3---48.476.085.2---
Uniter^{b}83.695.797.7---68.789.293.9---
CLIP88.098.799.458.481.588.168.790.695.237.862.472.2
...
IIIT5K Hateful
MNIST SVHN1kMemes SST-2

SOTA99.8^{a}96.4^{b}98.9^{c}78.0^{d}97.5^{e}
...
UC_{To}F_{p}1_{-1}01K_{AV}70_{G}0_{mWA}R_{P}areA_{m}c_{W}t_{SAP}
...
HT100M S3D^{d}--30.534.8
CLIP80.369.640.744.8
...
<!-- page:47 -->
Learning Transferable Visual Models From Natural Language Supervision47

ININ-V2IN-AIN-RObjectNetIN-SketchIN-VidYTBB
Top-1Top-1Top-1Top-1Top-1Top-1PM0PM10PM0PM10

NS EfficientNet-L2^{a}88.380.284.974.768.547.688.082.167.763.5
FixResNeXt101-32x48d V2^{b}86.478.068.480.057.859.185.872.268.957.7
...
1km25km200km750km2500km

ISNs^{a}16.943.051.966.780.2
CPlaNet^{b}16.537.146.462.078.5
CLIP13.932.943.062.079.3
Deep-Ret+^{c}14.433.347.761.673.4
PlaNet^{d}8.424.537.653.671.3
...
<!-- page:48 -->
Learning Transferable Visual Models From Natural Language Supervision48

1. F. Model Hyperparameters

HyperparameterValue

Batch size32768
Vocabulary size49408
Training epochs32
Maximum temperature100.0
Weight decay0.2
Warm-up iterations2000
Adam β10.9
Adam β20.999 (ResNet), 0.98 (ViT)
Adam ϵ10^{−8} (ResNet), 10^{−6} (ViT)

*Table 18. Common CLIP hyperparameters*

LearningEmbeddingInputResNetText Transformer
Modelratedimensionresolutionblockswidthlayerswidthheads

RN505 × 10^{−}^{4}1024224(3, 4, 6, 3)2048125128
RN1015 × 10^{−}^{4}512224(3, 4, 23, 3)2048125128
RN50x45 × 10^{−}^{4}640288(4, 6, 10, 6)25601264010
RN50x164 × 10^{−}^{4}768384(6, 8, 18, 8)30721276812
RN50x643.6 × 10^{−}^{4}1024448(3, 15, 36, 10)409612102416

*Table 19. CLIP-ResNet hyperparameters*

LearningEmbeddingInputVision TransformerText Transformer
Modelratedimensionresolutionlayerswidthheadslayerswidthheads

ViT-B/325 × 10^{−}^{4}5122241276812125128
ViT-B/165 × 10^{−}^{4}5122241276812125128
ViT-L/144 × 10^{−}^{4}768224241024161276812
ViT-L/14-336px2 × 10^{−}^{5}768336241024161276812
