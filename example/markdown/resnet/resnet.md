...
that has two layers, F = W_{2}σ(W_{1}x) in which σ denotes
...
|  |  | 3x3 conv, 64 |
|  |  | 3x3 conv, 64 |
|  | pool, /2 | 3x3 conv, 128, /2 |
|  | 3x3 conv, 512 | 3x3 conv, 128 |
|  | 3x3 conv, 512 | 3x3 conv, 128 |
|  | 3x3 conv, 512 | 3x3 conv, 128 |
|  | 3x3 conv, 512 | 3x3 conv, 128 |
|  |  | 3x3 conv, 128 |
...
### 34-laye_{im}r_{a} _{g}r_{e}esidual
...
and the models are trained for up to 60 × 10^{4} iterations. We
...
<!-- page:5 -->
#### layer name output size18-layer34-layer50-layer101-layer152-layer
...
FLOPs1.8×10^{9}3.6×10^{9}3.8×10^{9}7.6×10^{9}11.3×10^{9}
...
as a bottleneck design^{4}. For each residual function F, we
...
### ^{4}Deeper non-bottleneck ResNets (e.g., Fig. 5 left) also gain accuracy
...
ResNet-44
ResNet-56
56-layerResNet-110 |  |  |  |  |  | residual-110
residual-1202 |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| error (%) |  |  |  | error (%) |  |  | error (%) |  |  |
...
[23] Y. LeCun, L. Bottou, G. B. Orr, and K.-R. Mu¨ller. Efficient backprop.
...
### [28] G. Montu´far, R. Pascanu, K. Cho, and Y. Bengio. On the number of
...
<!-- page:10 -->
1. A. Object Detection Baselines
...
tion.
    ...
    1. B. Object Detection Improvements
...
### systemnetdatamAPareobikebirdboatbottlebuscarcatchaircowtabledoghorsembike personplantsheepsofatraintv
...
baselineResNet-10107+1276.479.8 80.7 76.2 68.3 55.9 85.1 85.3 89.8 56.7 87.8 69.4 88.3 88.9 80.9 78.4 41.7 78.6 79.8 85.3 72.0
baseline+++ ResNet-101COCO+07+1285.690.0 89.6 87.8 80.8 76.1 89.9 89.9 89.6 75.5 90.0 80.7 89.6 90.3 89.1 88.7 65.4 88.1 85.6 89.0 86.8
...
baseline+++ ResNet-101 COCO+07++1283.892.1 88.4 84.8 75.9 71.4 86.3 87.8 94.2 66.8 89.4 69.2 93.9 91.9 90.9 89.6 67.9 88.2 76.8 90.3 80.0
...
RPNResNet-101 1-crop13.3
RPNResNet-101 dense11.7
RPNResNet-101 denseResNet-10114.4
RPN+RCNN ResNet-101 denseResNet-10110.6
RPN+RCNNensembledenseensemble8.9
